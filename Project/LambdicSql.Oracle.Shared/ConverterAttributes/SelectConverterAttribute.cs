...
using LambdicSql.Oracle.Inside.CodeParts;
using LambdicSql.Oracle.MultiplatformCompatibe;
using System.Linq.Expressions;
using static LambdicSql.Oracle.Inside.PartsUtils;

namespace LambdicSql.Oracle.ConverterAttributes
{
    /// <summary>
